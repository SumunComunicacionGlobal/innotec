...
if ( ! function_exists( 'innotec_posted_on' ) ) :
	...
	function innotec_posted_on() {
		...
		$posted_on = sprintf(
			...
			esc_html_x( 'Posted on %s', 'post date', 'innotec' ),
...
if ( ! function_exists( 'innotec_posted_by' ) ) :
	...
	function innotec_posted_by() {
		$byline = sprintf(
			...
			esc_html_x( 'by %s', 'post author', 'innotec' ),
	...
	function innotec_entry_footer() {
		...
		if ( 'post' === get_post_type() ) {
			...
			if ( $categories_list ) {
				...
				printf( '<span class="cat-links">' . esc_html__( 'Posted in %1$s', 'innotec' ) . '</span>', $categories_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
			...
			if ( $tags_list ) {
				...
				printf( '<span class="tags-links">' . esc_html__( 'Tagged %1$s', 'innotec' ) . '</span>', $tags_list ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped
			}
		}
