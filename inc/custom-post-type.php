...
// let's create the function for the custom type - Casos de éxito
function custom_post_menu_widgets() { 
    // creating (registering) the custom type 
    register_post_type( 'menu-widget', /* (http://codex.wordpress.org/Function_Reference/register_post_type) */
        // let's now add all the options for this post type
        array('labels' => array(
            'name' => __('Widgets Mega Menú', 'innotec'), /* This is the Title of the Group */
            'singular_name' => __('Widget Mega Menú', 'innotec'), /* This is the individual type */
            'all_items' => __('Todos los Widgets', 'innotec'), /* the all items menu item */
            'add_new' => __('Añadir nuevo', 'innotec'), /* The add new menu item */
            'add_new_item' => __('Añadir nuevo Widget', 'innotec'), /* Add New Display Title */
            'edit' => __( 'Editar', 'innotec' ), /* Edit Dialog */
            'edit_item' => __('Editar Widget', 'innotec'), /* Edit Display Title */
            'new_item' => __('Nuevo Widget', 'innotec'), /* New Display Title */
            'view_item' => __('Ver Widget', 'innotec'), /* View Display Title */
            'search_items' => __('Buscar Widget', 'innotec'), /* Search Custom Type Title */ 
            'not_found' =>  __('Nada encontrado en base de datos.', 'innotec'), /* This displays if there are no entries yet */ 
            'not_found_in_trash' => __('Nada econtrado en papelera', 'innotec'), /* This displays if there is nothing in the trash */
            'parent_item_colon' => ''
            ), /* end of arrays */
...
// adding the function to the Wordpress init
add_action( 'init', 'custom_post_menu_widgets');